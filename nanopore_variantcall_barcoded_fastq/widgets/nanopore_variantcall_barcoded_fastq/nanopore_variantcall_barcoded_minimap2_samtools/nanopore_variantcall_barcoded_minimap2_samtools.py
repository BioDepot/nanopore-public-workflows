...
class OWnanopore_variantcall_barcoded_minimap2_samtools(OWBwBWidget):
    name = "nanopore_variantcall_barcoded_minimap2_samtools"
    ...
    def __init__(self):
        ...
        with open(getJsonName(__file__,"nanopore_variantcall_barcoded_minimap2_samtools")) as f:
