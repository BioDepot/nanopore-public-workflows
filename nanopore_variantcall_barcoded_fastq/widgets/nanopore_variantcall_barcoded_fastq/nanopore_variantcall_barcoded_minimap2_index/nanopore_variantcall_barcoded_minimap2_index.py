...
class OWnanopore_variantcall_barcoded_minimap2_index(OWBwBWidget):
    name = "nanopore_variantcall_barcoded_minimap2_index"
    ...
    def __init__(self):
        ...
        with open(getJsonName(__file__,"nanopore_variantcall_barcoded_minimap2_index")) as f:
