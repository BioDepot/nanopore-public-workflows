...
class OWnanopore_variantcall_barcoded_dorado(OWBwBWidget):
    name = "nanopore_variantcall_barcoded_dorado"
    ...
    def __init__(self):
        ...
        with open(getJsonName(__file__,"nanopore_variantcall_barcoded_dorado")) as f:
