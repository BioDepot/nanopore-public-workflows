...
class OWdorado(OWBwBWidget):
    ...
    inputs = [("InputDir",str,"handleInputsInputDir"),("trigger",str,"handleInputstrigger"),("trigger2",str,"handleInputstrigger2"),("trigger3",str,"handleInputstrigger3"),("reference",str,"handleInputsreference"),("OutputDir",str,"handleInputsOutputDir"),("modelFile",str,"handleInputsmodelFile"),("modelDir",str,"handleInputsmodelDir"),("outputfile",str,"handleInputsoutputfile"),("demuxReads",str,"handleInputsdemuxReads")]
    ...
    def handleInputsoutputfile(self, value, *args):
        if args and len(args) > 0: 
            ...
            self.handleInputs("inputFile", value, None, False)
    def handleInputsdemuxReads(self, value, *args):
        if args and len(args) > 0: 
            self.handleInputs("demuxReads", value, args[0][0], test=args[0][3])
        else:
            self.handleInputs("inputFile", value, None, False)
