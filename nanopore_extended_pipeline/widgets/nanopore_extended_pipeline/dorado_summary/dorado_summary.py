...
class OWdorado_summary(OWBwBWidget):
    name = "dorado_summary"
    ...
    inputs = [("inputBam",str,"handleInputsinputBam"),("Trigger",str,"handleInputsTrigger"),("outputDir",str,"handleInputsoutputDir")]
    ...
    def __init__(self):
        ...
        with open(getJsonName(__file__,"dorado_summary")) as f:
